...
//var monkey = function (name,species,foodsEaten) {
  ...
  //var mak = new monkey('mak', 'A','banana');
  //console.log(monkey.name + ' is ' + monkey.species + 'eaten' + monkey.foodsEaten);

  //monkey.prototype.identity = function() {
  //  console.log(this.name + ' is ' + this.species + 'eaten' + monkey.foodsEaten);
  //}
